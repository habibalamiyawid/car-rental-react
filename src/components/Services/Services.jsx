...
const skillsData = [
  
    {
      ...
      link:"#",
      description: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia placeat sint doloremque harum porro!",
      aosDelay: "0",
    },
    {
      name: "Fast and Safe",
        ...
        sm:grid-cols-2 md:grid-cols-3 gap-4">
          {
            skillsData.map((skill) =>(
             ...
             sm:space-y-6 p-4 sm:py-16 bg-dark hover:bg-primary text-white duration-300 text-white hover:text-black rounded-lg"
             >
              <div className="grid place-items-center text-black ">{skill.icon}</div>
              <h1>{skill.name}</h1>
